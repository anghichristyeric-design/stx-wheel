...
>(
  (
    ...
    switch (variant) {
      case "success":
        title = "Success",
        className = "hover:bg-green-700 bg-green-700/80 backdrop-blur-lg"
        Icon = (
          <RiCheckboxCircleFill
      ...
      case "warning":
        title = "Warning",
        className = "hover:bg-yellow-600 bg-yellow-600/80 backdrop-blur-lg"
        Icon = (
          <RiErrorWarningFill
            className="size-5 shrink-0 fill-white"
            aria-hidden="true"
      ...
      case "error":
        title = "Error",
        className = "hover:bg-red-700 bg-red-700/80 backdrop-blur-lg"
        Icon = (
          <RiCloseCircleFill
            className="size-5 shrink-0 fill-white"
            aria-hidden="true"
      ...
      case "loading":
        title = "Loading",
        className = "hover:bg-sky-600 bg-sky-600/80 backdrop-blur-lg"
        Icon = (
          <RiLoader2Fill
            className="size-5 shrink-0 animate-spin fill-white"
            aria-hidden="true"
          />
        )
        break
      default:
        title = "Info",
        className = "hover:bg-sky-500 bg-sky-500/80 backdrop-blur-lg"
        Icon = (
          <RiInformationFill
            className="size-5 shrink-0 fill-white"
            aria-hidden="true"
    ...
    return (
      <ToastPrimitives.Root
        ...
        className={cx(
          ...
          // background color
          "hover:bg-opacity-100 bg-sky-700 bg-opacity-80 backdrop-blur-lg",
          // border color
          " ",
          // swipe
      ...
      >
        ...
        <div className="flex flex-col">
          {!disableDismiss && (
            <ToastPrimitives.Close className="mt-[10px] mr-[10px]">
              <svg
